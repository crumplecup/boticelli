...
Documents that may be outdated or superseded by newer implementations:
...
- **crates/botticelli_narrative/narratives/discord/BUG_TABLE_INPUT_RESPONSE_LOSS.md** - `4bdd0b1` (2025-11-27)
  - Bug report and investigation (may be resolved)
- **crates/botticelli_core/REFACTOR.md** - `c0a1603` (2025-11-19)
  - Core crate refactoring notes (possibly completed)

## Document Categories Summary

- **Active Planning**: 20 documents
